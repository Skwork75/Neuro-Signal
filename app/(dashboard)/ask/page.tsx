...
export default function AskPage() {
  ...
  return <div className="mx-auto max-w-3xl space-y-6">
    <div><p className="text-sm font-medium text-indigo-600">Private retrieval</p><h1 className="text-3xl font-semibold tracking-tight text-slate-900">Ask your journal</h1><p className="mt-1 text-sm text-slate-600">Find relevant moments in your own writing. Results always point back to your words.</p></div>
